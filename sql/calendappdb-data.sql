...
insert into groups(name, admin, coment, shared) values('UPC-DSA', 'angel', 'grupo con los eventos de la asignatura DSA de la UPC', true);

insert into groups(name, admin, coment, shared) values('Fiestas locas', 'jordi', 'Todas las fiestas brutales!!!', false);

insert into groups(name, admin, coment, shared) values('Institucion Tecnologica Profesional SL', 'otal', 'Reuniones de la institucion', false);
